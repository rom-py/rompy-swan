"""SWAN source term models for GEN3 component.

This module contains all models used by the GEN3.source_terms field, including:
- Source term base class
- Third-generation source term models (JANSSEN, KOMEN, WESTHUYSEN, ST6, ST6C1-C5)

These are private implementation details used as field types in the GEN3 component.
"""
...
class JANSSEN(SourceTerms):
    ...
    .. ipython:: python
        ...
        from rompy_swan.components.physics._source_terms import JANSSEN
        janssen = JANSSEN()
...
class KOMEN(SourceTerms):
    ...
    .. ipython:: python
        ...
        from rompy_swan.components.physics._source_terms import KOMEN
        komen = KOMEN()
        print(komen.render())
...
class WESTHUYSEN(SourceTerms):
    ...
    .. ipython:: python
        ...
        from rompy_swan.components.physics._source_terms import WESTHUYSEN
...
class ST6C2(ST6C1):
    ...
    .. ipython:: python
        ...
        from rompy_swan.components.physics._source_terms import ST6C2
        st6 = ST6C2()
        print(st6.render())
...
class ST6C3(ST6C1):
    ...
    .. ipython:: python
        ...
        from rompy_swan.components.physics._source_terms import ST6C3
        st6 = ST6C3()
        print(st6.render())
...
class ST6C4(ST6C3):
    ...
    .. ipython:: python
        ...
        from rompy_swan.components.physics._source_terms import ST6C4
        st6 = ST6C4()
        print(st6.render())
...
class ST6C5(ST6C1):
    ...
    .. ipython:: python
        ...
        from rompy_swan.components.physics._source_terms import ST6C5
        st6 = ST6C5()
        print(st6.render())
