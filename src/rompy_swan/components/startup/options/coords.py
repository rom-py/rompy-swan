"""SWAN coordinate system options."""
...
class CARTESIAN(BaseComponent):
    ...
    .. ipython:: python
        ...
        from rompy_swan.components.startup.options.coords import CARTESIAN
        coords = CARTESIAN()
        print(coords.render())
    ...
    def cmd(self) -> str:
        """Render component cmd."""
        return "CARTESIAN"


class SPHERICAL(BaseComponent):
